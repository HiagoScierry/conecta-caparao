  ...
  const filteredAtracoes = useMemo(() => {
    ...
    return atracoes.filter((atracao: AtracaoTuristicaLoadedData) => {
      ...
      const matchSubcategoria =
        ...
        atracao.subcategorias.some((subcat) =>
          selectedSubcategorias.includes(subcat.id.toString()),
        );
      ...
      return (
        matchMunicipio && matchCategoria && matchSubcategoria && matchPerfil
      );
    });
  }, [
    atracoes,
          ...
          <Tabs defaultValue="atrativos" className="w-full">
            ...
            <TabsContent value="atrativos">
              ...
              <div className="w-full mb-6 mt-6 flex justify-between items-center">
                <div className="text-tourism-cinza">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-tourism-marinho text-white rounded-lg hover:bg-tourism-marinho/80 transition-colors"
                >
                  Limpar Filtros
                </button>
              </div>
                ...
                <div className="w-full md:flex-1">
                  {filteredAtracoes.length === 0 ? (
                    <div className="text-center py-12">
                      <div className="text-tourism-cinza text-lg mb-4">
                        Nenhum atrativo encontrado
                      </div>
                      <p className="text-tourism-cinza">
              ...
              <div className="flex flex-col items-center md:flex-row md:items-start gap-6">
                ...
                <div className="w-full md:flex-1">
                  {filteredServicos.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                      {filteredServicos?.map(
                        (servico: ServicoTuristicoFull) => (
                          <Link
