                ...
                <div className="container mx-auto py-16 px-8  md:px-16 ">
                    ...
                    <main className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-8 w-full">
                        ...
                        <form className="w-full order-1 md:order-2 space-y-4">
                          ...
                          focus:outline-none focus:ring-2 focus:ring-new-marinho bg-white/50"
                          ...
                          focus:outline-none focus:ring-2 focus:ring-new-marinho bg-white/50"
                            ...
                            <div className="flex justify-center">
                                <button
                                    type="submit"
                                    className="px-6 py-2 bg-new-marinho text-white rounded-md hover:bg-new-marinho/80 hover:shadow-lg transition-colors"
                                >
                                    Enviar Mensagem
                                </button>
                            </div>
                        ...
                        <div className="w-full order-2 md:order-1 space-y-4">
                            <h1 className="font-title text-4xl text-new-marinho font-bold">
                                Fale Conosco
                            </h1>
                            <p>
                                <span>
